                ...
                <article class="article">
                    ...
                    <?php
                        if ($post->post_type == 'report') {
                            echo '<br><p><a href="'._::acfField('pdf', $post->ID).'" target="_blank" class="button button__secondary button--small button--rounded theme--dark">
                                    <i class="icon">
                            ...
                            echo '<br><br><a href="/get-involved/jobs-and-internships/" class="button button__primary__outline button--rounded">See all jobs and internships</a>';
                        }
                    ?>
                </article>
